...
import { getassociatestatelist } from 'src/app/Store/Associate/Associate.Selectors';
import { loadassociate, getassociate, openpopup, deleteassociate } from 'src/app/Store/Associate/Associate.Action';
...
export class AssociatelistingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.store.select(getassociatestatelist).subscribe(item => {
